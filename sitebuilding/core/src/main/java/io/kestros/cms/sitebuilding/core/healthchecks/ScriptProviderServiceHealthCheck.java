...
@Component
@HealthCheckService(name = "Script Provider Service Check",
                    tags = {"kestros", "cms-foundation"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ScriptProviderServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ScriptProviderServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public String getServiceName() {
    return "Script Provider Service";
  }
}
