 ...
 */
@Component(service = {ResourceChangeListener.class, PageCachePurgeEventListener.class},
...
public class PageCachePurgeEventListener extends BaseCachePurgeOnResourceChangeEventListener {
  ...
  public List<CacheService> getCacheServices() {
    ...
    cacheServices.addAll(
        getAllOsgiServicesOfType(getComponentContext(), ComponentTypeCacheService.class));
