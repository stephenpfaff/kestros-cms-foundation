...
/**
 * Health Check for {@link PageCacheService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "Page Cache Service Check",
                    tags = {"kestros", "cms-foundation"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "PageCacheServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class PageCacheServiceHealthCheck extends BaseManagedServiceHealthCheck
