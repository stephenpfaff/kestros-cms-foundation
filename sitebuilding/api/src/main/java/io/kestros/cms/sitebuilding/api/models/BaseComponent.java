...
public class BaseComponent extends BaseResource {
  ...
  public RelativeDate getLastModified() {
    return JcrPropertyUtils.getRelativeDate(this, "kes:lastModified");
  }
  ...
  public RelativeDate getCreated() {
    return JcrPropertyUtils.getRelativeDate(this, "kes:created");
  }
  ...
  void attemptContentAreaResourceCreation() {
  ...
  void attemptSlingResourceTypeAssignment() {
