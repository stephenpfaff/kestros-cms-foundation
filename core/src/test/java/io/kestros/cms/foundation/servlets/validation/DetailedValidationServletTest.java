...
public class DetailedValidationServletTest {

  @Rule
  public SlingContext context = new SlingContext();

  private DetailedValidationServlet detailedValidationServlet;
  ...
  public void doValidation() {
    ...
    detailedValidationServlet = new DetailedValidationServlet();
    detailedValidationServlet.doValidation(model);
    verify(model, times(1)).doDetailedValidation();
    verify(model, never()).validate();
  }
  ...
  public void doGet() throws ServletException, IOException {
    ...
    detailedValidationServlet = new DetailedValidationServlet();
    context.registerInjectActivateService(detailedValidationServlet);
    detailedValidationServlet.doGet(context.request(), context.response());
