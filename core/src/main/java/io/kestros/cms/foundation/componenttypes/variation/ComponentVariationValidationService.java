...
/**
 * Validation Service for {@link ComponentVariation} models.
 */
public class ComponentVariationValidationService extends ModelValidationService {

  @Override
  public ComponentVariation getModel() {
    return (ComponentVariation) getGenericModel();
  }
