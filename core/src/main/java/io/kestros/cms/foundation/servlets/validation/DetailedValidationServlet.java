 ...
 * match the requested to resource to the closest matching Sling Model that extends {@link
 * BaseSlingModel} in order to determine
...
public class DetailedValidationServlet extends BaseValidationServlet {
