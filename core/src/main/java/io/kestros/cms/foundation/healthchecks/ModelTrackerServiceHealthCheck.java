...
import io.kestros.cms.foundation.services.ModelTrackerService;
 ...
 */
@Component
@HealthCheckService(name = "Model Tracker Service Check",
                    tags = {"kestros", "cms-foundation"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ModelTrackerServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ModelTrackerServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public ManagedService getCacheService() {
    return modelTrackerService;
  }

  @Override
  public String getServiceName() {
    return "Model Tracker Service";
  }
}
