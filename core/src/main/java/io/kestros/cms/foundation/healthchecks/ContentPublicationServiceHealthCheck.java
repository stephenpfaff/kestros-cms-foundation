...
@HealthCheckMBean(name = "ContentPublicationServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ContentPublicationServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public ManagedService getCacheService() {
    return contentPublicationService;
  }

  @Override
  public String getServiceName() {
    return "Content Publication Service";
  }
}
