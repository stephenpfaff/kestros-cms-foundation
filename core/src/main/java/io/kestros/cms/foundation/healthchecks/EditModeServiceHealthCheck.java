...
/**
 * Health Check for {@link EditModeService}.
 */
@Component
@HealthCheckService(name = "Edit Mode Service Check",
                    tags = {"kestros", "cms-foundation"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "EditModeServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class EditModeServiceHealthCheck extends BaseManagedServiceHealthCheck
