...
@Component
@HealthCheckService(name = "Component Type Retrieval Service Check",
                    tags = {"kestros", "component-types"})
@Async(intervalInSec = 300)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ComponentTypeRetrievalServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 300)
public class ComponentTypeRetrievalServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public ManagedService getCacheService() {
    return componentTypeRetrievalService;
  }
