...
@Component
@HealthCheckService(name = "Script Retrieval Service Check",
                    tags = {"kestros", "component-types"})
@Async(intervalInSec = 300)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ScriptRetrievalServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 300)
public class ScriptRetrievalServiceHealthCheck extends BaseManagedServiceHealthCheck
