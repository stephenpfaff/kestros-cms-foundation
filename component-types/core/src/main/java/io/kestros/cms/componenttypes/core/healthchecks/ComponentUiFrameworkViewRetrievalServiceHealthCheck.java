...
@Component
@HealthCheckService(name = "Component UI Framework View Retrieval Service Check",
                    tags = {"kestros", "component-types"})
@Async(intervalInSec = 300)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ComponentUiFrameworkViewRetrievalServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 300)
public class ComponentUiFrameworkViewRetrievalServiceHealthCheck
