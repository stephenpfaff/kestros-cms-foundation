...
/**
 * Health Check for {@link ComponentUiFrameworkViewService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "Component UI Framework View Service Check",
                    tags = {"kestros", "component-types"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ComponentUiFrameworkViewServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ComponentUiFrameworkViewServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public ManagedService getCacheService() {
    return componentUiFrameworkViewService;
  }
