...
public class ComponentVariationResourceTest {

  @Rule
  public SlingContext context = new SlingContext();

  private ComponentVariationResource variation;
  ...
  public void testIsInlineVariation() {
    ...
    resource = context.create().resource("/variations", properties);
    variation = resource.adaptTo(ComponentVariationResource.class);
