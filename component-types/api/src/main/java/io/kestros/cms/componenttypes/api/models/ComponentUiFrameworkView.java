...
import io.kestros.cms.uiframeworks.api.DesignConstants;
...
public class ComponentUiFrameworkView extends UiLibrary {
  ...
  public UiFramework getUiFramework() throws ResourceNotFoundException {
    return DesignUtils.getUiFrameworkByFrameworkCode(getName(), true, true, getResourceResolver());
  }
  ...
  private BaseResource getComponentVariationsRootResource()
    ...
    return getChildAsType(DesignConstants.NN_VARIATIONS, this, BaseResource.class);
  }
