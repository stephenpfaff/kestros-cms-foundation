...
public class ComponentType extends BaseResource {
  ...
  public List<ComponentTypeGroup> getAllowedComponentTypeGroups() {
    ...
    return ComponentTypeUtils.getComponentTypeGroups(
        ComponentTypeUtils.getAllComponentTypes(true, false, isAllowLibsCommonsComponents(),
            getResourceResolver()), getAllowedComponentTypePaths(), getExcludedComponentTypePaths(),
...
//        versionFormatException.printStackTrace();
    ...
    try {
      return ComponentTypeUtils.getComponentUiFrameworkView(uiFramework.getName(), this);
    } catch (final ChildResourceNotFoundException exception) {
