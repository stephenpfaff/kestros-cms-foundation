...
import static io.kestros.cms.uiframeworks.api.DesignConstants.UI_FRAMEWORKS_ETC_ROOT_PATH;
import static io.kestros.cms.uiframeworks.api.DesignConstants.UI_FRAMEWORKS_LIBS_ROOT_PATH;
import static io.kestros.cms.uiframeworks.api.DesignConstants.VENDOR_LIBRARIES_ETC_ROOT_PATH;
import static io.kestros.cms.uiframeworks.api.DesignConstants.VENDOR_LIBRARIES_LIBS_ROOT_PATH;
  ...
  public static List<VendorLibrary> getAllVendorLibraries(final ResourceResolver resolver,
    ...
    if (includeEtcVendorLibraries) {
      try {
        ...
        LOG.warn(
            "Unable to retrieve VendorLibrary resources from /libs. /libs Resource not found.");
      }
    }
