...
/**
 * Health Check for {@link HtlTemplateCachePurgeEventListener}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "HTL Template Cache Purge Event Listener Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "HtlTemplateCachePurgeEventListenerServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class HtlTemplateCachePurgeEventListenerHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private HtlTemplateCachePurgeEventListener htlTemplateCachePurgeEventListener;

  @Override
  public ManagedService getCacheService() {
    return htlTemplateCachePurgeEventListener;
  }
