...
/**
 * Health Check for {@link UiFrameworkOutputCacheService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "UI Framework Output Cache Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "UiFrameworkOutputCacheServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class UiFrameworkOutputCacheServiceHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private UiFrameworkOutputCacheService uiFrameworkOutputCacheService;

  @Override
  public ManagedService getCacheService() {
    return uiFrameworkOutputCacheService;
  }

  @Override
  public String getServiceName() {
    return "UI Framework Output Cache Service Health Check";
  }
}