...
/**
 * Health Check for {@link ThemeOutputCompilationService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "Theme Output Compilation Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ThemeOutputCompilationServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ThemeOutputCompilationServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public String getServiceName() {
    return "Theme Output Compilation Service Health Check";
  }
}