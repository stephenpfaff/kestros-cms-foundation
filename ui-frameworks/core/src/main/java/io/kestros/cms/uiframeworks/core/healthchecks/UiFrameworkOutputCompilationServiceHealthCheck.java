...
/**
 * Health Check for {@link UiFrameworkOutputCompilationService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "UI Framework Output Compilation Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "UiFrameworkOutputCompilationServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class UiFrameworkOutputCompilationServiceHealthCheck extends BaseManagedServiceHealthCheck
  ...
  public ManagedService getCacheService() {
    return uiFrameworkOutputCompilationService;
  }
