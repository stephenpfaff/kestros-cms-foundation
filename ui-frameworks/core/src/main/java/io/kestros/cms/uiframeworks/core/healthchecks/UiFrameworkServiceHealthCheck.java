...
/**
 * Health Check for {@link UiFrameworkRetrievalService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "UI Framework Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "UiFrameworkServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class UiFrameworkServiceHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private UiFrameworkRetrievalService uiFrameworkService;

  @Override
  public ManagedService getCacheService() {
    return uiFrameworkService;
  }

  @Override
  public String getServiceName() {
    return "UI Framework Service Health Check";
  }
}