...
/**
 * Health Check for {@link VendorLibraryRetrievalService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "Vendor Library Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "VendorLibraryServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class VendorLibraryRetrievalServiceHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private VendorLibraryRetrievalService vendorLibraryService;

  @Override
  public ManagedService getCacheService() {
    return vendorLibraryService;
  }

  @Override
  public String getServiceName() {
    return "Vendor Library Retrieval Service Health Check";
  }
}