...
/**
 * Health Check for {@link ThemeRetrievalService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "Theme Retrieval Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "ThemeRetrievalServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class ThemeRetrievalServiceHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private ThemeRetrievalService themeService;
  ...
  public String getServiceName() {
    return "Theme Retrieval Service Health Check";
  }
}