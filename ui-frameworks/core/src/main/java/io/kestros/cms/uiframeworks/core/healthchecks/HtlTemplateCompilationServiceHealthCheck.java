...
/**
 * Health Check for {@link HtlTemplateCompilationService}.
 */
@SuppressFBWarnings("RI_REDUNDANT_INTERFACES")
@Component
@HealthCheckService(name = "HTL Template Compilation Service Health Check",
                    tags = {"kestros", "ui-frameworks"})
@Async(intervalInSec = 60)
@ResultTTL(resultCacheTtlInMs = 10000)
@HealthCheckMBean(name = "HtlTemplateCompilationServiceHealthCheck")
@Sticky(keepNonOkResultsStickyForSec = 10)
public class HtlTemplateCompilationServiceHealthCheck extends BaseManagedServiceHealthCheck
    implements HealthCheck {

  @Reference(cardinality = ReferenceCardinality.OPTIONAL,
             policyOption = ReferencePolicyOption.GREEDY)
  private HtlTemplateCompilationService htlTemplateCompilationService;

  @Override
  public ManagedService getCacheService() {
    return htlTemplateCompilationService;
  }

  @Override
  public String getServiceName() {
    return "HTL Template Compilation Service Health Check";
  }
}